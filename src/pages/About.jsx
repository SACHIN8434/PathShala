            ...
            <section className="flex flex-col gap-5 items-center bg-richblack-700">
                <div className="lg:mt-[100px] text-white ">
                    ...
                    <header className="flex flex-col items-center text-4xl bg-richblack-700 justify-center text-center">
                        ...
                        <p className="font-normal flex items-center text-richblack-200 w-[60vw] text-base">PathShala is at the forefront of driving innovation in online education. We're passionate about creating a brighter future by offering cutting-edge courses, leveraging emerging technologies, and nurturing a vibrant learning community.</p>
                    </header>
