  ...
  return (
    <div>
      ...
      <div className="max-w-maxContent relative flex flex-col w-11/12 items-center text-white justify-between mx-auto">
        <Link to={"/signup"}>
          <div className="mt-5 group mx-auto rounded-full bg-richblack-800 text-richblack-200 font-bold transition-all duration-200 hover:scale-95 w-fit">
            <div className="flex flex-row items-center rounded-full gap-2 px-10 py-[10px] group-hover:bg-richblack-900">
        ...
        <div className="w-2/3 border-t-white border-t-[2px] my-12 mx-3 shadow-[0_20px_50px_rgba(8,_112,_184,_0.7)] ">
          <video
            loop
            muted
            autoPlay
        ...
        <div className="w-11/12 max-w-maxContent flex items-center gap-5 mx-auto justify-between flex-col">
          <div className="lg:flex lg:flex-row lg:gap-5 lg:mt-[90px] flex flex-col items-center justify-center gap-y-5">
            ...
            <div className="flex flex-col gap-10 lg:w-[40%] items-start">
              <p>The modern PathShala is the dictates its own terms. Today, to be a competitive specialist requires more than professional skills.</p>
              <CTAButton active={true} linkto={"/signup"}>
                <div>
                  Learn More
                </div>
