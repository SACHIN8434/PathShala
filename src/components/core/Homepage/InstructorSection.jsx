        ...
        <div className='mt-[10%]'>
            <div className=" lg:flex lg:flex-row gap-12 items-center flex flex-col justify-center">
                ...
                <div className="flex flex-col gpa-10 lg:w-[50%] gap-8">
                    ...
                    <p className="font-medium text-[16px] w-[80%] text-richblack-300"> Instructors from around the world teach millions of students on PathShala. We provide the tools and skills to teach what you love.</p>
